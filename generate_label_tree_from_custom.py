...
# Eg: python generate_label_tree_from_custom.py -m ../qubo_vision/datasets/2025_comp/labeled_background_subset/low_label_1783020702_phase2_yolo11n_autolab_best.pth -t 2025_comp -o 2025_comp_labels.csv
...
_, class_names = load_checkpoint(model_path, device="cpu")  # class_names is a list
names = {int(k): v for k, v in enumerate(class_names)}  # dict[int,str]
